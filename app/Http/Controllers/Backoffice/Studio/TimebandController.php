...
class TimebandController extends Controller
{
    public function edit(Request $request): Response
    {
        ...
        return Inertia::render('Backoffice/Studio/Timebands', compact('timebands', 'availability', 'hours', 'weekday', 'weekdays'));
    }
    ...
    public function update(Request $request): RedirectResponse
    {
        ...
        return back()->with('success',' Fascia oraria aggiornata');
    }
}
