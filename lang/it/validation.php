...
return [
    ...
    */
    ...
    'between' => [
        ...
        'file' => 'Il file deve essere tra :min e :max kilobyte.',
        'numeric' => 'Il numero deve essere tra :min e :max.',
        'string' => 'Il testo deve essere tra :min e :max caratteri.',
    ],
    ...
    'gt' => [
        ...
        'file' => 'Il file deve essere maggiore di :value kilobytes.',
        'numeric' => 'Il numero deve essere maggiore di :value.',
        'string' => 'Il testo deve essere maggiore di :value caratteri.',
    ],
    'gte' => [
        'array' => 'Il campo :attribute deve avere :value elementi o più.',
        'file' => 'Il file deve essere maggiore o uguale a :value kilobytes.',
        'numeric' => 'Il numero deve essere maggiore o uguale a :value.',
        'string' => 'Il testo deve essere maggiore o uguale a :value caratteri.',
    ],
    ...
    'lt' => [
        ...
        'file' => 'Il file deve essere inferiore a :value kilobytes.',
        'numeric' => 'Il numero deve essere inferiore a :value.',
        'string' => 'Il testo deve essere inferiore a :value caratteri.',
    ],
    'lte' => [
        'array' => 'Il campo :attribute non deve avere più di :value elementi.',
        'file' => 'Il file deve essere inferiore o uguale a :value kilobytes.',
        'numeric' => 'Il numero deve essere inferiore o uguale a :value.',
        'string' => 'Il testo deve essere inferiore o uguale a :value caratteri.',
    ],
    'mac_address' => 'Il campo :attribute deve essere un indirizzo MAC valido.',
    'max' => [
        'array' => 'Il campo :attribute non deve avere più di :max elementi.',
        'file' => 'Il file non deve essere maggiore di :max kilobytes.',
        'numeric' => 'Il numero non deve essere maggiore di :max.',
        'string' => 'Il testo non deve essere maggiore di :max caratteri.',
    ],
    ...
    'min' => [
        ...
        'file' => 'Il file deve essere di almeno :min kilobytes.',
        'numeric' => 'Il numero deve essere almeno :min.',
        'string' => 'Il testo deve essere di almeno :min caratteri.',
    ],
    'min_digits' => 'Il numero deve avere almeno :min cifre.',
    ...
    'required_if' => 'Campo obbligatorio quando :other è :value.',
    'required_if_accepted' => 'Campo obbligatorio quando :other è accettato.',
    'required_if_declined' => 'Campo obbligatorio quando :other è rifiutato.',
    'required_unless' => 'Campo obbligatorio a meno che :other non sia in :values.',
    'required_with' => 'Campo obbligatorio quando :values è presente.',
    'required_with_all' => 'Campo obbligatorio quando :values sono presenti.',
    'required_without' => 'Campo obbligatorio quando :values non è presente.',
    'required_without_all' => 'Campo obbligatorio quando nessuno di :values è presente.',
    'same' => 'Il campo :attribute deve corrispondere a :other.',
    'size' => [
        'array' => 'Il campo :attribute deve contenere :size elementi.',
        'file' => 'Il file deve essere :size kilobytes.',
        'numeric' => 'Il numero deve essere :size.',
        'string' => 'Il testo deve essere di :size caratteri.',
    ],
