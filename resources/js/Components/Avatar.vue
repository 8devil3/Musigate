<template>
    <div class="flex items-center justify-center size-10 overflow-hidden text-center bg-slate-900 border-2 border-orange-500 rounded-full shrink-0">
        ...
        <div v-else-if="!props.img" class="flex items-center justify-center w-full h-full overflow-hidden leading-none tracking-wider text-white uppercase bg-slate-900 rounded-full font-lemon">
