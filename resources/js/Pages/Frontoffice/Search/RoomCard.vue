<template>
    <article class="flex flex-col overflow-hidden border border-slate-500 min-h-40 bg-slate-900/75 rounded-xl">
        <div class="relative h-56">
            ...
            <div class="absolute flex items-center justify-center w-12 h-12 text-center border-2 border-orange-500 rounded-full bottom-2 left-3 bg-slate-900 shrink-0">
