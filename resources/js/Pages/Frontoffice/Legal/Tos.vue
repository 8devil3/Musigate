    ...
    <FrontofficeLayout title="Termini e condizioni">
        <div class="max-w-4xl py-8 mx-auto text-slate-200">
            ...
            <ol class="mt-4">
                <li>
                    ...
                    <ul class="list-disc">
                        <li>
                            ...
                            Aldo Cocourullo,
                            C.F. CCRLDA83M08M172M,
                            Partita IVA 04442720985,
                            PEC <a href="mailto:alc.dev@pec.it" class="text-orange-500 underline transition-colors hover:text-orange-400">alc.dev@pec.it</a>
                        </li>
                        <li>
                            <strong>Applicazione:</strong>
                            il sito web e l'applicazione
                            <Link :href="route('home')" class="text-orange-500 underline transition-colors hover:text-orange-400">https://musigate.it</Link>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            qualsiasi elemento testuale o multimediale presente sull'Applicazione, a titolo di esempio annunci, inserzioni, recensioni, immagini, etc.
                        </li>
                        <li>
                ...
                <li>
                    <h2 class="text-base">Ambito di applicazione delle Condizioni</h2>
                    ...
                    <p>Le Condizioni possono essere modificate in ogni momento.
                    Eventuali modifiche saranno in vigore dal momento della loro pubblicazione sull'Applicazione.</p>
                    ...
                    <p>Il Titolare si riserva il diritto di variare a propria discrezione, in qualunque momento
                    anche successivo alla registrazione dell'Utente, l'interfaccia grafica dell'Applicazione, i Contenuti e la loro organizzazione, nonché ogni altro aspetto che caratterizza la funzionalità e la gestione dell'Applicazione, comunicando all'Utente, ove occorrenti, le relative istruzioni.</p>
                </li>

                <li>
                    <h2 class="text-base">Registrazione</h2>

                    <p>Per usufruire delle funzionalità dell'Applicazione, gli Utenti devono registrarsi fornendo, in maniera veritiera e completa, tutti i dati richiesti nel relativo form di registrazione ed accettare integralmente la privacy policy (<Link :href="route('privacy')" class="text-orange-500 underline transition-colors hover:text-orange-400">https://musigate.it/privacy</Link>) e le Condizioni.</p>
                ...
                <li>
                    <h2 class="text-base">Contenuti inviati dagli Utenti</h2>
                ...
                <li>
                    <h2 class="text-base">Limitazione della Responsabilità</h2>
                ...
                <li>
                    <h2 class="text-base">Forza maggiore</h2>
                ...
                <li>
                    <h2 class="text-base">Collegamento a siti di terzi</h2>
                ...
                <li>
                    <h2 class="text-base">Privacy</h2>

                    <p>La tutela e il trattamento dei dati personali avverranno in conformità all'Informativa Privacy che può essere consultata alla pagina
                    <Link :href="route('privacy')" class="text-orange-500 underline transition-colors hover:text-orange-400">https://musigate.it/privacy</Link></p>
                </li>

                <li>
                    <h2 class="text-base">Legge applicabile e foro competente</h2>

                    <p>Le Condizioni sono soggette alla legge italiana.</p>
                    <p>Per gli utenti Professionisti, per ogni controversia relativa alla Applicazione, esecuzione e interpretazione delle presenti Condizioni è competente il foro di Brescia.</p>
