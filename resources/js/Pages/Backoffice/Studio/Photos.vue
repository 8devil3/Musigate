        ...
        <template #content>
            <FormElement>
                <template #description>
                    Carica le foto dello Studio: verranno mostrate nella galleria principale della pagina dello Studio.<br>
                    ...
                    <br>
                    <br>
                    <strong>Massimo 12 foto.</strong><br>
...
const featurePhoto = (photoId)=>{
    formFeature.put(route('studio.photos.featured', photoId), {
        preserveScroll: true,
    });
}
