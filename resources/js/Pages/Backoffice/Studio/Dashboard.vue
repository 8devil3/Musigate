            ...
            <div class="flex flex-col gap-6 p-4 md:gap-8 md:p-6 md:rounded-t-md">
                ...
                <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                    <div class="p-4 space-y-4 bg-gray-900 border-2 border-orange-600 rounded-xl">
                        ...
                        <Link :href="route('rooms.index')" class="font-medium text-orange-500 transition-colors hover:text-orange-400">Vai alle Sale Studio <i class="ml-1 fa-solid fa-arrow-right" /></Link>
                    </div>
