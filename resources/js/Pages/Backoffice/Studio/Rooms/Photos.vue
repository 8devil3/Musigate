<template>
    ...
    >
        ...
        <template v-if="form.selected_photos.length || (form.isDirty && !form.processing)" #actions>
            <Button @click="deleteSelectedPhotos()" text="Elimina" icon="fa-solid fa-trash-can" color="red" />
            <SaveButton />
        </template>
    </ContentLayout>
</template>
